...
public class AdapterLitCat2 extends ArrayAdapter<StrucSubCat2List> {

    public AdapterLitCat2(ArrayList<StrucSubCat2List> array) {
    ...
    private static class ViewHolder {
        ...
        public void fill(ArrayAdapter<StrucSubCat2List> adapter, final StrucSubCat2List item, int position) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        StrucSubCat2List item = getItem(position);
        if (convertView == null) {
