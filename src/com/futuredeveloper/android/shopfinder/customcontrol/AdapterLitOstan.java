...
public class AdapterLitOstan extends ArrayAdapter<StrucOstan> {

    public AdapterLitOstan(ArrayList<StrucOstan> array) {
        ...
        public void fill(ArrayAdapter<StrucOstan> adapter, final StrucOstan item, int position) {
            ...
            txtNameStore.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View arg0) {
                    G.btnOstan.setText(txtNameStore.getText().toString());
                    G.btnOstan.setTag(item.id);
                    G.dialogOstan.dismiss();
                }
            });
