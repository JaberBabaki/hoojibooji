...
public class AdapterLitCat extends ArrayAdapter<StrucCategories> {

    public AdapterLitCat(ArrayList<StrucCategories> array) {
    ...
    private static class ViewHolder {
        ...
        public void fill(ArrayAdapter<StrucCategories> adapter, final StrucCategories item, int position) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        StrucCategories item = getItem(position);
        if (convertView == null) {
