...
public class ImageIndi extends ImageView {
    ...
    public ImageIndi(Context context) {
        super(context);
        initialize();
    }


    public ImageIndi(Context context, AttributeSet attrs) {
        super(context, attrs);
        initialize();
    }


    public ImageIndi(Context context, AttributeSet attrs, int defStyle) {
